...
class dt_obat extends BaseController
{
    ...
    public function updateobat()
    {
        ...
        if (strlen($harga_beli) < 8) {
            $beli = $harga_beli * 1000;
        } else if (strlen($harga_beli) < 12) {
            $count_harga = explode(".", $harga_beli);
            $beli = $count_harga[0] . $count_harga[1] . $count_harga[2];
        }

        $harga_jual = $this->request->getVar('jual');
        if (strlen($harga_jual) < 8) {
            $jual = $harga_jual * 1000;
        } else if (strlen($harga_jual) < 12) {
            $count_harga = explode(".", $harga_jual);
            $jual = $count_harga[0] . $count_harga[1] . $count_harga[2];
        }
