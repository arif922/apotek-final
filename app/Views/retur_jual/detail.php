...
<section class="content-header">
    ...
    <h1>
        <i class="fas fa-file-invoice"></i> Rincian Retur Penjualan
        <a class="btn btn-danger pull-right" style="margin-left: 11px;" href="/returjual/view" title="" data-toggle="tooltip">
            Kembali
        </a>
...
<div class="kotak" hidden>
    <div style="color:#3c8dbc" class="login-logo">
        ...
        <p class="center" style="font-size: 30px; margin-bottom: -30px;"><b> Retur Penjualan Obat</b></p>
    ...
    <div class="pusing" style="margin-left: 25px; font-size: 15px; margin-bottom: -20px;">
        <?php foreach ($cetak as $c) : ?>
            Kode Retur Penjualan : <?= $c['kd_returjual']; ?> <br>
            ...
            <div class="box box-warning">
                <div class="box-body table-responsive">
                    ...
                    <table id="example1" class="table table-striped table-hover">
                        ...
                        <tbody>
                            <?php $i = 1; ?>
                            <?php foreach ($detailreturjual as $m) : ?>
                                <tr class='center hilang2'>
                                    <td width='40'><?= $i++; ?></td>

                                    <!-- <td><?= $m['kd_returjual']; ?></td> -->
                                    <td><?= $m['det_kd_returjual']; ?></td>
                                    <td><?= $m['nama_obat']; ?></td>
                                    <td><?= $m['kode_obat']; ?></td>
