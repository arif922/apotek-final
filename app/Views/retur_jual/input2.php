...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="/returjual/view"> Retur Penjualan </a></li>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <!-- form start -->
                <form role="form" class="form-horizontal" method="POST" action="/retur_penjualan/tambahdump_rj" enctype="multipart/form-data">
                    <div class="box-body row" style="padding: 25px;">
                        <!-- kiri -->
                        <div class="col-sm-6">
                            <div class="form-group ">
                                <div class="col-sm-12">
                                    <label class="">Kode Retur Jual</label>
                                    <input type="text" class="form-control" name="kd_returjual" autocomplete="off" value="<?= $kdtrans; ?>" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    ...
                                    <input type="text" class="form-control" name="det_kd_returjual" autocomplete="off" value="<?= $kddet;
                            ...
                            <div class="form-group">
                                <div class="col-sm-9">
                                    ...
                                    <?php foreach ($cari_obat2 as $ob2) : ?>
                                        <input type="text" class="form-control" id="nama_obat" value="<?= $ob2['nama_obat']; ?>" name="nm_obat" required readonly>
                                    <?php endforeach; ?>

                                </div>
                                <div class="col-sm-3">
                                    <label class="" style="visibility: hidden;">Cari Obat</label>
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    ...
                                    <?php foreach ($cari_obat2 as $ob2) : ?>
                                        <input type="text" class="form-control" id="kode_obat" name="kode_obat" autocomplete="off" value="<?= $ob2['kode_obat']; ?>" readonly>
                                    <?php endforeach; ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group" hidden>
                                <div class="col-sm-12">
                                    <label class=" text-xl-left">Customer</label>
                                    <?php foreach ($cari_obat2 as $ob2) : ?>
                                        <input type="text" class="form-control" id="id_customer" name="id_customer" autocomplete="off" value="<?= $ob2['id_customer']; ?>" readonly>
                                    <?php endforeach; ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-12" style="margin-top: 20px;">
                                    ...
                                    <a href="/returjual/view" class="btn btn-danger btn-reset btn-standar">Batal</a>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    ...
                                    <div class="input-group"> <span class="input-group-addon">Rp.</span>
                                        <?php foreach ($cari_obat2 as $ob2) : ?>
                                            <input type="text" name="harga_jual" class="form-control" id="h_jual" value="<?= number_format($ob2['harga_jual'], 0, ",", "."); ?>" readonly />
                                        <?php endforeach ?>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    ...
                                    <?php foreach ($cari_obat2 as $ob2) : ?>
                                        <input type="number" id="jml_beli" min="1" class="form-control" name="jumlah_beli" value="<?= $ob2['jumlah_keluar']; ?>" readonly>
                                    <?php endforeach ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    ...
                                    <?php foreach ($cari_obat2 as $ob2) : ?>
                                        <input type="number" id="jml_keluar" min="1" max="<?= $ob2['jumlah_keluar']; ?>" class="form-control" onkeyup="penjualan()" onchange="penjualan()" name="jumlah_rj" autocomplete="off" maxlength="13" onKeyPress="return goodchars(event,'0123456789',this)" value="" required>
                                    <?php endforeach ?>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body" style="height: 390px;">
                                <form action="/retur_penjualan/simpan_returjual" method="POST">

                                    <input type="hidden" class="form-control" name="kode_returjual" autocomplete="off" value="<?= $kdtrans; ?>" readonly>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <?php foreach ($cari_obat2 as $ob2) : ?>
                                                <?php
                                                session()->set('nama', $ob2['nama_customer']);
                                                session()->set('id', $ob2['id_customer']);
                                                ?>
                                                <input type="text" class="form-control" id="nama_customer" name="customer" autocomplete="off" value="<?= $ob2['nama_customer']; ?>" readonly>
                                            <?php endforeach; ?>
                                        </div>
                                        <div hidden>
                                            <label class="col-sm-1 control-label ">Id</label>
                                            ...
                                            <div class="col-sm-2">
                                                <?php foreach ($cari_obat2 as $ob2) : ?>
                                                    <input type="text" class="form-control" id="id_customer" name="id_customer" autocomplete="off" value="<?= $ob2['id_customer']; ?>" readonly required>
                                                <?php endforeach; ?>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <!-- <div class="form-group">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="input-group"> <span class="input-group-addon">Rp.</span>
                                                <input type="text" name="tunai2" class="form-control" onkeyup="detail_jual()" id="tunaii" value="" onKeyPress="return goodchars(event,'01234567890',this)" required />
                                            </div>
                                        </div>
                                    </div> -->
                    ...
                    <div class="modal-dialog" style="width: 800px;">
                        <div class="modal-content">
                            <div class="modal-header" style="background-color:  steelblue; color: white;">
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span></button>
                                <h4 class="modal-title"><b>Data Penjualan</b> </h4>
                            </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php foreach ($cari_obat as $data) : ?>
                                                        <tr>
                                                            ...
                                                            <td class="center">
                                                                <a id="nama_obat" title="" class="btn btn-success btn-sm" href="/returjuall/tambah/<?= $data['kode_detail']; ?>">
                                                                    Pilih
                                                                </a>
                                                            </td>
        ...
        <?php echo view('retur_jual/view_dump'); ?>
</section><!-- /.content -->
