                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    ...
                                    <input type="number" id="jml_keluar" min="1" class="form-control" onkeyup="penjualan()" onchange="penjualan()" name="jumlah_rj" autocomplete="off" maxlength="13" onKeyPress="return goodchars(event,'0123456789',this)" value="" required>
                                </div>
                            </div>
                                ...
                                <form action="/retur_penjualan/simpan_returjual" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            $id =  session()->get('id');
                                            ?>
                                            <input type="text" class="form-control" id="nama_customer" name="customer" autocomplete="off" value="<?= $nama; ?>" readonly>
                                        </div>
                                        <div hidden>
                                            <label class="col-sm-1 control-label ">Id</label>
                                            <div class="col-sm-2">
                                                <input type="text" class="form-control" id="id_customer" name="id_customer" autocomplete="off" value="<?= $id; ?>" readonly required>
