    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <!-- form start -->
                <form role="form" class="form-horizontal" method="POST" action="/retur_pembelian/tambahdump_rb" enctype="multipart/form-data">
                    <div class="box-body row" style="padding: 25px;">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group" hidden>
                                <div class="col-sm-12">
                                    <label class=" text-xl-left">supplier</label>
                                    <?php foreach ($cari_obat2 as $ob2) : ?>
                                        <input type="text" class="form-control" id="id_supplier" name="id_supplier" autocomplete="off" value="<?= $ob2['id_supplier']; ?>" readonly>
                                    <?php endforeach; ?>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    ...
                                    <div class="input-group"> <span class="input-group-addon">Rp.</span>
                                        <?php foreach ($cari_obat2 as $ob2) : ?>
                                            <input type="text" name="harga_beli" class="form-control" id="h_beli" value="<?= number_format($ob2['harga_beli'], 0, ",", "."); ?>" readonly />
                                        <?php endforeach ?>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    ...
                                    <?php foreach ($cari_obat2 as $ob2) : ?>
                                        <input type="number" id="jml_beli" min="1" class="form-control" name="jumlah_beli" value="<?= $ob2['jumlah_masuk']; ?>" readonly>
                                    <?php endforeach ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    ...
                                    <?php foreach ($cari_obat2 as $ob2) : ?>
                                        <input type="number" id="jml_masuk" min="1" max="<?= $ob2['jumlah_masuk']; ?>" class="form-control" onkeyup="pembelian()" onchange="pembelian()" name="jumlah_rb" autocomplete="off" maxlength="13" onKeyPress="return goodchars(event,'0123456789',this)" value="" required>
                                    <?php endforeach ?>
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    ...
                                    <input type="text" class="form-control" id="keterangan" name="keterangan" autocomplete="off" value="">
                                </div>
                            </div>
                                ...
                                <form action="/retur_pembelian/simpan_returbeli" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <?php foreach ($cari_obat2 as $ob2) : ?>
                                                <?php
                                                session()->set('nama', $ob2['nama_supplier']);
                                                session()->set('id', $ob2['id_supplier']);
                                                ?>
                                                <input type="text" class="form-control" id="nama_supplier" name="supplier" autocomplete="off" value="<?= $ob2['nama_supplier']; ?>" readonly>
                                            <?php endforeach; ?>
                                        </div>
                                        <div hidden>
                                            <label class="col-sm-1 control-label ">Id</label>
                                            ...
                                            <div class="col-sm-2">
                                                <?php foreach ($cari_obat2 as $ob2) : ?>
                                                    <input type="text" class="form-control" id="id_supplier" name="id_supplier" autocomplete="off" value="<?= $ob2['id_supplier']; ?>" readonly required>
                                                <?php endforeach; ?>
                                            </div>
                                        </div>
                                    </div>
