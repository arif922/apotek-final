                    ...
                    <table id="example1" class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <?php foreach ($viewdump as $det) : ?>
                                <tr class='center'>
                                    <td width='40'><?= $i++; ?></td>
                                    <!-- <td><?= $det['kd_returbeli']; ?></td> -->
                                    <td><?= $det['det_kd_returbeli']; ?></td>
                                    <td><?= $det['nama_obat']; ?></td>
                                    <td><?= $det['kode_obat']; ?></td>
                                    ...
                                    <td class='center' width='80'>
                                        <div>
                                            <a data-toggle="modal" id="hapus" title="" class="btn btn-danger btn-sm" href="#H<?= $det['det_kd_returbeli']; ?>">
                                ...
                                <!-- Modal hapus -->
                                <div class="modal fade" id="H<?= $det['det_kd_returbeli']; ?>">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <p>Apakah Anda yakin ingin menghapus data retur penbelian <?= $det['det_kd_returbeli']; ?> ? </p>
                                            </div>
                                            <div class="modal-footer">
                                                <a type="button" class="btn btn-danger" href="/hapus_dump_rb/<?= $det['det_kd_returbeli']; ?>">Ya</a>
