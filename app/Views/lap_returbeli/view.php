...
<section class="content-header">
    <h1>
        <i class="fas fa-chart-bar"></i> Laporan Retur Pembelian
    </h1>
    <ol class="breadcrumb">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div style="background: white; padding-top: 15px;">
                <!-- form start -->
                <form role="form" class="form-horizontal" method="POST" action="<?php echo base_url('/laporan_rb/lihat_lap_rb'); ?>">
                    <div class="box-body hapus">
                        <div class="col-sm-6">
                            <?php
                            $rb_awal = session()->get('rb_awal');
                            $rb_akhir = session()->get('rb_akhir');

                            // $tgl1 = date('d/m/Y', strtotime($rb_awal));
                            // $tgl2 = date('d/m/Y', strtotime($rb_akhir));
                            ?>
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    ...
                                    <input type="date" class="form-control" name="rb_awal" autocomplete="off" value="<?= $rb_awal; ?>" required>
                            ...
                            <div class="form-group">
                                <div class="col-sm-12" style="margin-top: 15px;">
                                    ...
                                    <a href="/lap_returbeli/view" class="btn btn-default btn-submit" style="margin-right: 11px;"> Refresh</a>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    ...
                                    <input type="date" class="form-control" name="rb_akhir" autocomplete="off" value="<?= $rb_akhir; ?>" required>
                    ...
                    <div class="kotak" hidden>
                        <div style="color:#3c8dbc" class="login-logo">
                            ...
                            <p class="center" style="font-size: 32px; margin-bottom: -30px;"><b> Laporan Retur Pembelian</b></p>
                            <?php if ($rb_awal == null && $rb_akhir == null) : ?>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="box-body table-responsive">
                                    ...
                                    <table id="example5" class="table table-striped table-hover">
                                        ...
                                        <tbody>
                                            <?php $i = 1; ?>
                                            <?php foreach ($laprb as $o) : ?>
                                                <tr class="hilang2">
                                                    <td class='center' width='40'><?= $i++; ?></td>
                                                    <td><?= $o['kd_returbeli']; ?></td>
