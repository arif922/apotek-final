...
<section class="content-header">
    <h1>
        ...
        <a class="btn btn-danger pull-right" href="/persetujuann/<?= $kd_so; ?>" title="" data-toggle="tooltip">
            Kembali
        </a>
    </h1>
        ...
        <div class="col-md-12">
            ...
            <?php if (session()->getFlashdata('blm_disesuaikan')) : ?>
                <div class='alert alert-gagal'>
                    ...
                    <?= session()->getFlashdata('blm_disesuaikan'); ?>
                </div>
            <?php endif; ?>
                                ...
                                <tr class='center'>
                                    ...
                                    <td class='center' width='80'>
                                        <div>
                                            ...
                                            <a title="" class="btn btn-success btn-sm" href="/det_persetujuan2/<?= $m['det_kd_so']; ?>">
                                                <!-- <i style="color:#fff" class="glyphicon glyphicon-list-alt"></i> -->Lihat
                                            </a>
                                        </div>
                                    </td>
                                </tr>
